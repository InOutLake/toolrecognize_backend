...
class Session(TimestampMixin, Base):
    ...
    reciever_id: DB_ID_TYPE = mapped_column(ForeignKey("employee.id"))
    giver_id: DB_ID_TYPE = mapped_column(ForeignKey("employee.id"))
    location_id: DB_ID_TYPE = mapped_column(ForeignKey("location.id"))
    kit_id: DB_ID_TYPE = mapped_column(ForeignKey("kit.id"))
...
class SessionTool(TimestampMixin, Base):
    ...
    tool_id: DB_ID_TYPE = mapped_column(ForeignKey("tool.id"))
    session_id: DB_ID_TYPE = mapped_column(ForeignKey("session.id"))
